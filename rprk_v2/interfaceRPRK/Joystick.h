...
#define REG_SEND_MSG_JOYSTICK 70 // Joystick send messages
#define REG_RECEIVE_MSG_JOYSTICK 71 // Joystic receive messages
#define REG_SEND_DATA_JOYSTICK 72 // Joystick send data (direction)
